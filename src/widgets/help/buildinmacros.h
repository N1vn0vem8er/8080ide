...
private:
    ...
    const QStringList helpPagesList{"printchar", "inchar", "gclear", "gdraw", "gx", "gy", "gline", "gpfill", "gpfigure", "gfill", "gcfelipse", "gpfelipse", "gcelipse", "gpelipse", "gcancel", "randset", "randin"};
};

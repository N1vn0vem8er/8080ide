...
private:
    ...
    QString language;
    QStringList helpPagesList = {"helloworld", "helloworld2", "drawline", "drawcircle", "drawfigure"};
    QStringList translations = {tr("Hello World"), tr("Hello World 2"), tr("Draw line"), tr("Draw circle"), tr("Draw figure")};
};

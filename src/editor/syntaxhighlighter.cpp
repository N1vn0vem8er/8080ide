    ...
    : QSyntaxHighlighter(parent)
{
    ...
    rule.pattern = QRegularExpression(QStringLiteral("[a-z|A-Z|0-9]*:"));
    rule.format = keywordFormat;
    highlightingRules.append(rule);
    ...
    const QString spellCheck[] = {QStringLiteral("^([a-z|A-Z|0-9]*:\\s|\\tMVI\\s[A-EHML]\\,.*)|MVI\\s[A-EHML]\\,.*$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(MOV\\s[A-EHML]\\,[A-EHML])((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(STAX\\s[BD])((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(LDAX\\s[BD])((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(LDA\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(STA\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(RPO\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(RP\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(JNZ\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(JNC\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(JPO\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(JP\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(JMP\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(CZN\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(CNC\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(CPO\\s.*)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(CP\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(RST\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(RET\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(PCHL)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(RZ\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(RC\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(RPE\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(RM\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(JZ\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(JC\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(JPE\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(JM\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(CZ\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(CC\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(CPE\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(CM\\s.*)((\\s|\\t)\\;.*)?$" ),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(CALL\\s.*)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(INR\\s[A-EHML])((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(DCR\\s[A-EHML])((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(RLC$)((\\s|\\t)\\;.*)?") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(RAL\\s.*)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(DAA$)((\\s|\\t)\\;.*)?") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(STC$)((\\s|\\t)\\;.*)?") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(RRC)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(RAR)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(CMA)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(CMC\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(ADD\\s[A-EHML])((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(SUB\\s[A-EHML])((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(ADC\\s.*)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(SBB\\s[A-EHML])((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(ANA\\s[A-EHML])((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(XRA\\s[A-EHML])((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(ORA\\s[A-EHML])((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(CMP\\s[A-EHML])((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(ADI\\s.*)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(SUI\\s.*)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(ANI\\s.*)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(ORI\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(ACI\\s.*)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(SBI\\s.)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(XRI\\s.*)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(CPI\\s.*)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(LXI\\s([A-EHML]|SP)\\,.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(SHLD\\s.*)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(LHLD\\s.*)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(POP\\s[BDH])((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(PUSH\\s[BDH])((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(SPHL)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(XCHG)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(XTHL)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(NOP)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(HLT)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(OUT\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(IN\\s.*)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(DI)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(EI)((\\s|\\t)\\;.*)?$") ,
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(RNC)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(INX\\s([BDH]|SP))((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(DAD\\s([A-EHML]|SP))((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(DCX\\s([BDH]|SP))((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^\\.*$"),
                                  QStringLiteral("^\\:.*$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(STRING\\s\".*\")((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(ARRAY\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(EQU\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(SET\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(END)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(IF\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^ENDIF((\\s|\\t)\\;.*)$"),
                                  QStringLiteral("^ENDM((\\s|\\t)\\;.*)$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)(MACRO)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(DB\\s.*)((\\s|\\t)\\;.*)?$"),
                                  QStringLiteral("^(([a-z|A-Z|0-9])*:\\s|\\t)?(DW\\s.*)((\\s|\\t)\\;.*)?$")};
